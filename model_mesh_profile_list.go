...
// checks if the MeshProfileList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MeshProfileList{}

// MeshProfileList Profile list
type MeshProfileList struct {
	// API Version of the mesh profile list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the mesh profile resources
	Items []MeshProfile `json:"items,omitempty"`
	// Kind of the mesh profile list resource
...
// SetItems gets a reference to the given []MeshProfile and assigns it to the Items field.
...
func (o MeshProfileList) MarshalJSON() ([]byte, error) {
...
func (o MeshProfileList) ToMap() (map[string]interface{}, error) {
...
type NullableMeshProfileList struct {
	value *MeshProfileList
	isSet bool
}

func (v NullableMeshProfileList) Get() *MeshProfileList {
	return v.value
}

func (v *NullableMeshProfileList) Set(val *MeshProfileList) {
	v.value = val
	v.isSet = true
}

func (v NullableMeshProfileList) IsSet() bool {
	return v.isSet
}

func (v *NullableMeshProfileList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMeshProfileList(val *MeshProfileList) *NullableMeshProfileList {
	return &NullableMeshProfileList{value: val, isSet: true}
}

func (v NullableMeshProfileList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMeshProfileList) UnmarshalJSON(src []byte) error {
	v.isSet = true
