...
// checks if the WorkloadList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WorkloadList{}

// WorkloadList Workload list
type WorkloadList struct {
	// API Version of the workload list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the workload resources
	Items []Workload `json:"items,omitempty"`
	// Kind of the workload list resource
...
// SetItems gets a reference to the given []Workload and assigns it to the Items field.
...
func (o WorkloadList) MarshalJSON() ([]byte, error) {
...
func (o WorkloadList) ToMap() (map[string]interface{}, error) {
...
type NullableWorkloadList struct {
	value *WorkloadList
	isSet bool
}

func (v NullableWorkloadList) Get() *WorkloadList {
	return v.value
}

func (v *NullableWorkloadList) Set(val *WorkloadList) {
	v.value = val
	v.isSet = true
}

func (v NullableWorkloadList) IsSet() bool {
	return v.isSet
}

func (v *NullableWorkloadList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWorkloadList(val *WorkloadList) *NullableWorkloadList {
	return &NullableWorkloadList{value: val, isSet: true}
}

func (v NullableWorkloadList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWorkloadList) UnmarshalJSON(src []byte) error {
	v.isSet = true
