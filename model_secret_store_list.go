...
// checks if the SecretStoreList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecretStoreList{}

// SecretStoreList Secret Store list
type SecretStoreList struct {
	// API Version of the secret store list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the secret store resources
	Items []SecretStore `json:"items,omitempty"`
	// Kind of the secret store list resource
...
// SetItems gets a reference to the given []SecretStore and assigns it to the Items field.
...
func (o SecretStoreList) MarshalJSON() ([]byte, error) {
...
func (o SecretStoreList) ToMap() (map[string]interface{}, error) {
...
type NullableSecretStoreList struct {
	value *SecretStoreList
	isSet bool
}

func (v NullableSecretStoreList) Get() *SecretStoreList {
	return v.value
}

func (v *NullableSecretStoreList) Set(val *SecretStoreList) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretStoreList) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretStoreList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretStoreList(val *SecretStoreList) *NullableSecretStoreList {
	return &NullableSecretStoreList{value: val, isSet: true}
}

func (v NullableSecretStoreList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretStoreList) UnmarshalJSON(src []byte) error {
	v.isSet = true
