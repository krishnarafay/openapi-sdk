...
// checks if the NamespaceMeshRuleSpec type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamespaceMeshRuleSpec{}

// NamespaceMeshRuleSpec namespace mesh rule  specification
type NamespaceMeshRuleSpec struct {
...
func (o NamespaceMeshRuleSpec) MarshalJSON() ([]byte, error) {
...
func (o NamespaceMeshRuleSpec) ToMap() (map[string]interface{}, error) {
...
type NullableNamespaceMeshRuleSpec struct {
	value *NamespaceMeshRuleSpec
	isSet bool
}

func (v NullableNamespaceMeshRuleSpec) Get() *NamespaceMeshRuleSpec {
	return v.value
}

func (v *NullableNamespaceMeshRuleSpec) Set(val *NamespaceMeshRuleSpec) {
	v.value = val
	v.isSet = true
}

func (v NullableNamespaceMeshRuleSpec) IsSet() bool {
	return v.isSet
}

func (v *NullableNamespaceMeshRuleSpec) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamespaceMeshRuleSpec(val *NamespaceMeshRuleSpec) *NullableNamespaceMeshRuleSpec {
	return &NullableNamespaceMeshRuleSpec{value: val, isSet: true}
}

func (v NullableNamespaceMeshRuleSpec) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamespaceMeshRuleSpec) UnmarshalJSON(src []byte) error {
	v.isSet = true
