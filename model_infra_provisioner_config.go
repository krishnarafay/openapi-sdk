...
// checks if the InfraProvisionerConfig type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InfraProvisionerConfig{}

// InfraProvisionerConfig infrastructure provisioner configuration
...
func (o InfraProvisionerConfig) MarshalJSON() ([]byte, error) {
...
func (o InfraProvisionerConfig) ToMap() (map[string]interface{}, error) {
...
type NullableInfraProvisionerConfig struct {
	value *InfraProvisionerConfig
	isSet bool
}

func (v NullableInfraProvisionerConfig) Get() *InfraProvisionerConfig {
	return v.value
}

func (v *NullableInfraProvisionerConfig) Set(val *InfraProvisionerConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableInfraProvisionerConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableInfraProvisionerConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInfraProvisionerConfig(val *InfraProvisionerConfig) *NullableInfraProvisionerConfig {
	return &NullableInfraProvisionerConfig{value: val, isSet: true}
}

func (v NullableInfraProvisionerConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInfraProvisionerConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true
