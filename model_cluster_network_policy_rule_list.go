...
// checks if the ClusterNetworkPolicyRuleList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterNetworkPolicyRuleList{}

// ClusterNetworkPolicyRuleList ClusterNetworkPolicyRule  list
type ClusterNetworkPolicyRuleList struct {
	// API Version of the network rule list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the network rule resources
	Items []ClusterNetworkPolicyRule `json:"items,omitempty"`
...
func NewClusterNetworkPolicyRuleList() *ClusterNetworkPolicyRuleList {
	this := ClusterNetworkPolicyRuleList{}
	return &this
}
...
func (o *ClusterNetworkPolicyRuleList) GetItems() []ClusterNetworkPolicyRule {
	if o == nil || isNil(o.Items) {
		var ret []ClusterNetworkPolicyRule
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []ClusterNetworkPolicyRule and assigns it to the Items field.
...
func (o ClusterNetworkPolicyRuleList) MarshalJSON() ([]byte, error) {
...
func (o ClusterNetworkPolicyRuleList) ToMap() (map[string]interface{}, error) {
...
type NullableClusterNetworkPolicyRuleList struct {
	value *ClusterNetworkPolicyRuleList
	isSet bool
}

func (v NullableClusterNetworkPolicyRuleList) Get() *ClusterNetworkPolicyRuleList {
	return v.value
}

func (v *NullableClusterNetworkPolicyRuleList) Set(val *ClusterNetworkPolicyRuleList) {
	v.value = val
	v.isSet = true
}

func (v NullableClusterNetworkPolicyRuleList) IsSet() bool {
	return v.isSet
}

func (v *NullableClusterNetworkPolicyRuleList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableClusterNetworkPolicyRuleList(val *ClusterNetworkPolicyRuleList) *NullableClusterNetworkPolicyRuleList {
	return &NullableClusterNetworkPolicyRuleList{value: val, isSet: true}
}

func (v NullableClusterNetworkPolicyRuleList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableClusterNetworkPolicyRuleList) UnmarshalJSON(src []byte) error {
	v.isSet = true
