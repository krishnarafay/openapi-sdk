...
// ConfigContext Configuration context contains environment variables and other supporting variables
type ConfigContext struct {
	// API Version of the config context resource
	ApiVersion string `json:"apiVersion"`
	// Kind of the config context resource
	Kind string `json:"kind"`
	Metadata Metadata `json:"metadata"`
	Spec ConfigContextSpec `json:"spec"`
