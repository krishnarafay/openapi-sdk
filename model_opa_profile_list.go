...
// OPAProfileList OPAProfile  list
type OPAProfileList struct {
	// API Version of the OPAProfile list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the OPAProfile resources
	Items []OPAProfile `json:"items,omitempty"`
	// Kind of the OPAProfile list resource
...
// SetItems gets a reference to the given []OPAProfile and assigns it to the Items field.
