...
// checks if the OPAConstraintList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &OPAConstraintList{}

// OPAConstraintList OPAConstraint  list
type OPAConstraintList struct {
	// API Version of the constraint list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the constraint resources
	Items []OPAConstraint `json:"items,omitempty"`
	// Kind of the constraint list resource
...
// SetItems gets a reference to the given []OPAConstraint and assigns it to the Items field.
...
func (o OPAConstraintList) MarshalJSON() ([]byte, error) {
...
func (o OPAConstraintList) ToMap() (map[string]interface{}, error) {
...
type NullableOPAConstraintList struct {
	value *OPAConstraintList
	isSet bool
}

func (v NullableOPAConstraintList) Get() *OPAConstraintList {
	return v.value
}

func (v *NullableOPAConstraintList) Set(val *OPAConstraintList) {
	v.value = val
	v.isSet = true
}

func (v NullableOPAConstraintList) IsSet() bool {
	return v.isSet
}

func (v *NullableOPAConstraintList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOPAConstraintList(val *OPAConstraintList) *NullableOPAConstraintList {
	return &NullableOPAConstraintList{value: val, isSet: true}
}

func (v NullableOPAConstraintList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOPAConstraintList) UnmarshalJSON(src []byte) error {
	v.isSet = true
