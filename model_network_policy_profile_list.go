...
// checks if the NetworkPolicyProfileList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkPolicyProfileList{}

// NetworkPolicyProfileList Profile list
type NetworkPolicyProfileList struct {
	// API Version of the policy list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the profile resources
	Items []NetworkPolicyProfile `json:"items,omitempty"`
...
// SetItems gets a reference to the given []NetworkPolicyProfile and assigns it to the Items field.
...
func (o NetworkPolicyProfileList) MarshalJSON() ([]byte, error) {
...
func (o NetworkPolicyProfileList) ToMap() (map[string]interface{}, error) {
...
type NullableNetworkPolicyProfileList struct {
	value *NetworkPolicyProfileList
	isSet bool
}

func (v NullableNetworkPolicyProfileList) Get() *NetworkPolicyProfileList {
	return v.value
}

func (v *NullableNetworkPolicyProfileList) Set(val *NetworkPolicyProfileList) {
	v.value = val
	v.isSet = true
}

func (v NullableNetworkPolicyProfileList) IsSet() bool {
	return v.isSet
}

func (v *NullableNetworkPolicyProfileList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNetworkPolicyProfileList(val *NetworkPolicyProfileList) *NullableNetworkPolicyProfileList {
	return &NullableNetworkPolicyProfileList{value: val, isSet: true}
}

func (v NullableNetworkPolicyProfileList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNetworkPolicyProfileList) UnmarshalJSON(src []byte) error {
	v.isSet = true
