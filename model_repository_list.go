...
type RepositoryList struct {
	// API Version of the repository list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the repository resources
	Items []Repository `json:"items,omitempty"`
	// Kind of the repository list resource
...
// SetItems gets a reference to the given []Repository and assigns it to the Items field.
