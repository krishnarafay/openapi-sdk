...
// checks if the NamespaceNetworkPolicyList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NamespaceNetworkPolicyList{}

// NamespaceNetworkPolicyList Namespace policy list
type NamespaceNetworkPolicyList struct {
	...
	Items []NamespaceNetworkPolicy `json:"items,omitempty"`
...
func NewNamespaceNetworkPolicyList() *NamespaceNetworkPolicyList {
	this := NamespaceNetworkPolicyList{}
	return &this
}
...
func (o *NamespaceNetworkPolicyList) GetItems() []NamespaceNetworkPolicy {
	if o == nil || isNil(o.Items) {
		var ret []NamespaceNetworkPolicy
		return ret
	}
	return o.Items
}
...
// SetItems gets a reference to the given []NamespaceNetworkPolicy and assigns it to the Items field.
...
func (o NamespaceNetworkPolicyList) MarshalJSON() ([]byte, error) {
...
func (o NamespaceNetworkPolicyList) ToMap() (map[string]interface{}, error) {
...
type NullableNamespaceNetworkPolicyList struct {
	value *NamespaceNetworkPolicyList
	isSet bool
}

func (v NullableNamespaceNetworkPolicyList) Get() *NamespaceNetworkPolicyList {
	return v.value
}

func (v *NullableNamespaceNetworkPolicyList) Set(val *NamespaceNetworkPolicyList) {
	v.value = val
	v.isSet = true
}

func (v NullableNamespaceNetworkPolicyList) IsSet() bool {
	return v.isSet
}

func (v *NullableNamespaceNetworkPolicyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableNamespaceNetworkPolicyList(val *NamespaceNetworkPolicyList) *NullableNamespaceNetworkPolicyList {
	return &NullableNamespaceNetworkPolicyList{value: val, isSet: true}
}

func (v NullableNamespaceNetworkPolicyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableNamespaceNetworkPolicyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
