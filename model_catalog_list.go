...
type CatalogList struct {
	// API Version of the catalog list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the catalog resources
	Items []Catalog `json:"items,omitempty"`
	// Kind of the catalog list resource
...
// SetItems gets a reference to the given []Catalog and assigns it to the Items field.
