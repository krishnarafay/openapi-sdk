...
// checks if the SecretGroupList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecretGroupList{}

// SecretGroupList SecretGroup list
type SecretGroupList struct {
	// API Version of the SecretGroup list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the SecretGroup resources
	Items []SecretGroup `json:"items,omitempty"`
	// Kind of the SecretGroup list resource
...
// SetItems gets a reference to the given []SecretGroup and assigns it to the Items field.
...
func (o SecretGroupList) MarshalJSON() ([]byte, error) {
...
func (o SecretGroupList) ToMap() (map[string]interface{}, error) {
...
type NullableSecretGroupList struct {
	value *SecretGroupList
	isSet bool
}

func (v NullableSecretGroupList) Get() *SecretGroupList {
	return v.value
}

func (v *NullableSecretGroupList) Set(val *SecretGroupList) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretGroupList) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretGroupList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretGroupList(val *SecretGroupList) *NullableSecretGroupList {
	return &NullableSecretGroupList{value: val, isSet: true}
}

func (v NullableSecretGroupList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretGroupList) UnmarshalJSON(src []byte) error {
	v.isSet = true
