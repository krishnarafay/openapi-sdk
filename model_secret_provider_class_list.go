...
// checks if the SecretProviderClassList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SecretProviderClassList{}

// SecretProviderClassList SecretProviderClass list
type SecretProviderClassList struct {
	// API Version of the provider class list resource
	ApiVersion *string `json:"apiVersion,omitempty"`
	// List of the provider class resources
	Items []SecretProviderClass `json:"items,omitempty"`
	// Kind of the provider class list resource
...
// SetItems gets a reference to the given []SecretProviderClass and assigns it to the Items field.
...
func (o SecretProviderClassList) MarshalJSON() ([]byte, error) {
...
func (o SecretProviderClassList) ToMap() (map[string]interface{}, error) {
...
type NullableSecretProviderClassList struct {
	value *SecretProviderClassList
	isSet bool
}

func (v NullableSecretProviderClassList) Get() *SecretProviderClassList {
	return v.value
}

func (v *NullableSecretProviderClassList) Set(val *SecretProviderClassList) {
	v.value = val
	v.isSet = true
}

func (v NullableSecretProviderClassList) IsSet() bool {
	return v.isSet
}

func (v *NullableSecretProviderClassList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecretProviderClassList(val *SecretProviderClassList) *NullableSecretProviderClassList {
	return &NullableSecretProviderClassList{value: val, isSet: true}
}

func (v NullableSecretProviderClassList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecretProviderClassList) UnmarshalJSON(src []byte) error {
	v.isSet = true
